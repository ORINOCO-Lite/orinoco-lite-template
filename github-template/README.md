...
This is an Orinoco Lite metadata-driven website. It is composed from a complete
versioned website under `.orinoco-lite/site/` and this repository's declarative
...
The engine and template are selected exactly in `orinoco.lock` and
`.copier-answers.yml`. Choosing another template version is a deliberate
replacement, not an in-repository framework update.
