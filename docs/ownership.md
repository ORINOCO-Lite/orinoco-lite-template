...
| `consumer_tests` | Created once, then owned and extended by the site | browser, integration, offline, parity, and contract tests |
| `site_policy` | Always decided by the site | licensing, citation, contribution, and conduct files |
| `generated` | Replaceable only after declared inputs validate | projection and update ledgers under `generated/` |

The updater hashes every protected site-owned and generated byte before and after Copier runs.
